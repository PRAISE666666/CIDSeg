...
class Cityscapes(Dataset):
    ...
    def __init__(self, transforms, dataset_root, mode='train', edge=False):
        ...
        # if mode == 'train':
        #     self.file_list = get_list('/home/praiselab/YHT/home_1/datasets/cityscapes/trainval.list', self.dataset_root)
        # elif mode == 'val':
        #     self.file_list = get_list('/home/praiselab/YHT/home_1/datasets/cityscapes/val.list', self.dataset_root)
        # elif mode == 'test':
